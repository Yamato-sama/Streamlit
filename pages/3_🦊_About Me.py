...
st.header("Strength")
st.write("My greatest strength is my ability to learn something quickly because I come from the IT field and it needs a lot of research.")

st.header("Weakness")
st.write("To be honest with you . I am a low-key person. I like to spend time alone. And don't like to spend time with many people. If I do I only spend time with the people I feel comfortable with.")